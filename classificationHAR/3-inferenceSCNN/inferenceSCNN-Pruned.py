...
def main(datasetName, encoding, filterbank, channel, bins, structure, quartile):
    ...
    modelCNN = tf.keras.models.load_model(f'{sourceFolder}{datasetName}{filterbank}{channel}x{bins}{structure}{quartile}{encoding}.keras', custom_objects={'Relu': Relu, 'Masking': Masking})
...
if __name__ == '__main__':
    ...
    if flagCompute == True:
        accuracyTrain, accuracyTest, synapses = main(datasetName, encoding, filterbank, channel, bins, structure, quartile)
