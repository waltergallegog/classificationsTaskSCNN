...
def main(encoding, filterbank, channel, bins, structure, quartile):
    ...
    modelCNN = tf.keras.models.load_model(f'{sourceFolder}{filterbank}{channel}x{bins}{structure}{encoding}.keras', custom_objects={'Relu': Relu})
...
if __name__ == '__main__':
    ...
    if flagCompute == True:
        ...
        for trial in range(trials):
            accuracyTrain, accuracyTest, synapses, modelCNNPruned = main(encoding, filterbank, channel, bins, structure, quartile)
        ...
        modelCNNPruned.save(f'{sourceFolder}{filterbank}{channel}x{bins}{structure}{quartile}{encoding}.keras')
