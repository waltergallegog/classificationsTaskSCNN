...
# ##### Inference loop ##### #
##############################
def main(encoding, filterbank, channel, bins, structure, reduction):
    ###############################
    # ##### Dataset loading ##### #
    ###############################
...
if __name__ == '__main__':
    ...
    if flagCompute == True:
        accuracyTrain, accuracyTest, synapses = main(encoding, filterbank, channel, bins, structure, reduction)
