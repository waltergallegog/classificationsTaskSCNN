...
class SNN:
    def __init__(self, data_shape, spike_train, model_cnn, neuron_set, filter_code=(0, 0, 0, 0, 0, 0)):
                            ...
                            for col in range(output_data_col):
                                ...
                                for kernel_row in range(kernel_rows):
                                    for kernel_col in range(kernel_cols):
                                        ...
                                        elif weight < 0 and not skip:
                                            synapse_inhib.append((index_receptive_field, index_neuron, weight, 1.0))
                        self.synapses += len(synapse_excit) + len(synapse_inhib)
